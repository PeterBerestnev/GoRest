...
// URLSacer is an autogenerated mock type for the URLSaver type
...
// NewURLSaver creates a new instance of URLSaver. It also registers a testing interface on the mock and ckeanup function to assert the mocks expectations.
